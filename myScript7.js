...
let nombreCompleto = "Andrés Fëlipe Öspina Vahos";
...
document.getElementById("demo7.32").innerHTML = nombreAcento;
...
document.getElementById("demo7.33").innerHTML = texto3;


//Elimina los espacios de una cadena a sus dos lados
let texto4 = "               Soy un texto con espacio          ";
let texto5 = texto4.trim();
document.getElementById("demo7.34").innerHTML = texto4;
document.getElementById("demo7.35").innerHTML = texto5;
document.getElementById("demo7.36").innerHTML = texto4.length;
document.getElementById("demo7.37").innerHTML = texto5.length;


//Completar cadenas padStart(cantidad, elemento) y padEnd(cantidad, elemento)
let texto6 = "Saludo"
document.getElementById("demo7.38").innerHTML = texto6.padStart(20,"-");
document.getElementById("demo7.39").innerHTML = texto6.padEnd(4,0);


//Extraer Caracteres de la cadena
//1. charAt()
let texto7 = "Extraer una letra";
document.getElementById("demo7.40").innerHTML = texto7.charAt(1);

//2. charCodeAt()
document.getElementById("demo7.41").innerHTML = texto7.charCodeAt(1);

//Acceso a la propiedad
document.getElementById("demo7.42").innerHTML = texto7[1];


//Convertir cadena a matriz
let texto8 = "a, b, c, d, e";
const miArreglo = texto8.split(",");
document.getElementById("demo7.43").innerHTML = miArreglo[3];

const miArreglo1 = texto7.split(" ");
document.getElementById("demo7.44").innerHTML = miArreglo1[2];
